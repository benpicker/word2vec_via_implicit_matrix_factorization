...
# builds the PMI matrix 
vocab_size = len(vocabulary)
vocab_to_idx = {k: v for v,k in enumerate(vocabulary)}
vocab_idx_reverse = {v: k for v,k in enumerate(vocabulary)}
...
with open('vocab_idx_reverse.pickle', 'wb') as handle:
	pickle.dump(vocab_idx_reverse, handle, protocol=pickle.HIGHEST_PROTOCOL)
